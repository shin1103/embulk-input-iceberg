...
public class JdbcDriverMangerLoaderSwap implements AutoCloseable{
    ...
    public JdbcDriverMangerLoaderSwap(IcebergInputPlugin.PluginTask task)
    {
        ...
        try {
            ...
            this.classLoader = new URLClassLoader(new URL[]{url}, IcebergInputPlugin.class.getClassLoader());
